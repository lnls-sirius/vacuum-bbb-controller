...
EPICS_CAS_SERVER_PORT=5068 PYEPICS_LIBCA=/opt/epics-R3.15.5/base/lib/linux-arm/libca.so python /root/vacuum-bbb-controller/software/pydm/pydm_1.2/scripts/initialization.py VBC1
